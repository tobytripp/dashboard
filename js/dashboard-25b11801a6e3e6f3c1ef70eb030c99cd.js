...
(function() {
  ...
  Dashboard.Cell = (function(_super) {
    ...
    Cell.prototype.initialize = function() {
      _.bindAll(this);
      this.frames = [];
      return this.on("add", this.assert_face);
    };
    ...
    Cell.prototype.each = function(callback) {
      return _.each(this.frames, callback);
    };

    Cell.prototype.add = function(frames) {
      var list,
        _this = this;
      list = frames instanceof Array ? frames : [frames];
      _.each(list, function(frame) {
        _this.frames.push(frame);
        _this.length = _this.frames.length;
        return _this.trigger("add", frame);
      });
      return this.trigger("change");
    };
    ...
    Cell.prototype.assert_face = function() {
      var front_frame;
      front_frame = _.find(this.frames, function(frame) {
        return frame.front();
      });
      if (!front_frame) {
        return this.frames[0].flip();
      }
    };
